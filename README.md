...
- **Looking to collaborate on:** Fullstack or mobile projects involving real-time features, marketplace dynamics, or complex UI systems. Reach out if you want to build something impactful.  
- **Need help with:** Scaling real-time systems and refining mobile-first UX for low-bandwidth environments.  
- **Ask me about:** React, Next.js, React Native, Supabase, or building production-ready apps for global markets.  
- **Pronouns:** He/Him  
- **Fun fact:** I'm an anime fan and enjoy competitive gaming in my free time.  
...
- **Streamlining Inventory Management (Techworld Gadgets) — Ibadan, Nigeria**  
  Led frontend integration of an inventory management system that boosted operational efficiency by 40%, cut order processing time by 30%, and reduced manual errors by 25%.  
  **Tech Stack:**  
  ![React](https://img.shields.io/badge/-React-61DAFB?logo=react&logoColor=white&style=flat-square) ![Context API](https://img.shields.io/badge/-Context%20API-61DAFB?logo=react&logoColor=white&style=flat-square) ![Tailwind CSS](https://img.shields.io/badge/-Tailwind%20CSS-06B6D4?logo=tailwindcss&logoColor=white&style=flat-square) ![Axios](https://img.shields.io/badge/-Axios-5A29E4?logo=axios&logoColor=white&style=flat-square)
...
![Reanimated](https://img.shields.io/badge/-Reanimated-FF6C37?logo=react&logoColor=white&style=flat-square)
![React Hook Form](https://img.shields.io/badge/-React%20Hook%20Form-007ACC?logo=react&logoColor=white&style=flat-square)
...
![TanStack Query](https://img.shields.io/badge/-TanStack%20Query-0055FF?logo=react&logoColor=white&style=flat-square)
![Recharts](https://img.shields.io/badge/-Recharts-FF6C37?logo=react&logoColor=white&style=flat-square)
...
![Zod](https://img.shields.io/badge/-Zod-000000?logo=typescript&logoColor=white&style=flat-square)

## Let's Connect
Feel free to reach out via [email](mailto:israelipinkz@gmail.com). You can also find me on [LinkedIn](http://www.linkedin.com/in/mikelisrael) and [Dev.to](https://dev.to/mikelisrael)

![Profile Views](https://komarev.com/ghpvc/?username=mikelisrael&style=flat-square)
